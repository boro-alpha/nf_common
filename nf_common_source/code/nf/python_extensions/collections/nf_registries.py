...
from nf_common_source.code.nf.types.common_collection_types import CommonCollectionTypes
from nf_common_source.code.services.input_output_service.access.csv_folder_to_database_loader import load_database_with_table
...
class NfRegistries:
    ...
    def export_dataframes_to_new_database(
        ...
        module = \
            importlib.import_module(
                name='nf_common_source.resources.templates')
    ...
    def update(
        ...
        if not collection_type in self.dictionary_of_collections.keys():
            self.dictionary_of_collections[collection_type] = \
                new_collection
