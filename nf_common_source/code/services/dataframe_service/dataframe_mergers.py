...
def merge_dataframes(
    ...
    stringified_master_dataframe_key_columns = \
        stringify_columns_in_dataframe(
            master_dataframe_key_columns,
            master_dataframe_copy)
    ...
    foreign_key_dataframe_all_columns = \
        list(foreign_key_dataframe_other_column_rename_dictionary.values()) + stringified_foreign_key_dataframe_fk_columns

    foreign_key_dataframe_copy = \
        foreign_key_dataframe_copy.filter(
            items=foreign_key_dataframe_all_columns)

    master_dataframe_copy = \
        master_dataframe_copy.merge(
    ...
    master_dataframe_copy.drop(
        columns=stringified_master_dataframe_key_columns + stringified_foreign_key_dataframe_fk_columns,
        inplace=True)
...
def stringify_columns_in_dataframe(
    ...
    for column in columns:
        stringified_column = \
            column + STRINGIFIED_COLUMN_SUFFIX
